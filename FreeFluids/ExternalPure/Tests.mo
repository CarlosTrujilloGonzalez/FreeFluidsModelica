...
package Tests
  ...
  model TestATMedia
    extends TestACubic(redeclare package Medium = FreeFluids.TMedia.Fluids.Water(refState = "User", highPressure = true, inputChoice = "ph"));
  end TestATMedia;
  ...
  model TestB
    extends FluidTest(Ps = 10.0e5, initialT = (-20) + 273.15, finalT = 320 + 273.15);
  end TestB;
