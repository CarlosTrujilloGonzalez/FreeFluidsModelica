...
package ExternalPure "ExternalPure.mo by Carlos Trujillo
  ...
  package ExternalMedium
    ...
    constant Integer ancillaries = 0 "if 0 no ancillary function will be used, if 1 they will be used for cubic EOS, if 2 for SAFT, and if 3 for SW. It indicates for which EOS are the functions fitted";
    
    constant Real T_min=150.0 "needed for compatibility with Buildings";
    constant Real TCri=fluidK.criticalTemperature "needed for compatibility with Buildings";
    constant Real pCri=fluidK.criticalPressure "needed for compatibility with Buildings";
