within FreeFluids.MediaCommon;
  ...
  constant FreeFluids.MediaCommon.DataRecord Ammonia(
    name = "Ammonia", description = "", CAS = "7664-41-7", family = 15, MW = 1.703100e+01, molarMass=0.017031, Tc = 4.056000e+02, Pc = 1.135000e+07, Vc = 7.250000e-05, Zc = 2.440000e-01, w = 2.560000e-01, Tb = 2.396500e+02, mu = 1.500000e+00, lnuA = 1.177011e-02, lnuB = -5.143356e+00,
  ...
  constant FreeFluids.MediaCommon.DataRecord Butane_n(
    name = "n-Butane", description = "", CAS = "106-97-8", family = 1, MW = 5.812000e+01, molarMass=0.05812, Tc = 4.251250e+02, Pc = 3.796000e+06, Vc = 2.549220e-04, Zc = 2.737700e-01, w = 2.010000e-01, Tb = 2.726500e+02, mu = 3.600000e-02, lnuA = 1.378235e-02, lnuB = -5.310408e+00,
    ...
    VpCorr = 24, VpCoef = {3.796000e+06, -7.035310e+00, 1.500440e+00, -2.589980e+00, -1.537080e+00, 4.251250e+02}, VpLimI = 1.381500e+02, VpLimS = 4.251200e+02,
    ...
    name = "n-Butanol", description = "", CAS = "71-36-3", family = 7, MW = 7.414000e+01, molarMass=0.07414, Tc = 5.630000e+02, Pc = 4.414000e+06, Vc = 2.740000e-04, Zc = 2.590000e-01, w = 5.930000e-01, Tb = 3.911500e+02, mu = 1.800000e+00, lnuA = 1.056184e-02, lnuB = -4.885318e+00,
  ...
  constant FreeFluids.MediaCommon.DataRecord Dichlorodifluormethane(
    ...
    constant  FreeFluids.MediaCommon.DataRecord EG(
     name="Ethylene glycol", CAS = "107-21-1", family = 8, MW = 6.207000e+01, molarMass=0.06207, Tc = 7.200000e+02, Pc = 8.200000e+06, Vc = 1.706000e-04, Zc = 2.340000e-01, w = 5.070000e-01, Tb = 4.707500e+02, mu=2.2, lnuA = 8.525900e-03, lnuB = -6.581590e+00, 
  ...
  constant FreeFluids.MediaCommon.DataRecord Ethane(
    name = "Ethane", description = "", CAS = "74-84-0", family = 1, MW = 3.007000e+01, molarMass = 3.007000e-02, Tc = 3.053220e+02, Pc = 4.872200e+06, Vc = 1.460000e-04, Zc = 2.800000e-01, w = 9.800000e-02, Tb = 1.845500e+02, mu = 0.000000e+00, lnuA = 1.605574e-02, lnuB = -5.754008e+00,
    ...
    VpCorr = 24, VpCoef = {4.883870e+06, -6.388380e+00, 1.201830e+00, -1.637770e+00, -1.332580e+00, 3.054000e+02}, VpLimI = 9.100000e+01, VpLimS = 3.053000e+02,
  ...
  constant FreeFluids.MediaCommon.DataRecord Ethanol(
    name = "Ethanol", description = "", CAS = "64-17-5", family = 7, MW = 4.607000e+01, molarMass=0.04607, Tc = 5.162000e+02, Pc = 6.383475e+06, Vc = 1.670000e-04, Zc = 2.480000e-01, w = 6.350000e-01, Tb = 3.511500e+02, mu = 1.700000e+00, lnuA = 1.021159e-02, lnuB = -4.904172e+00,
    ...
    constant  FreeFluids.MediaCommon.DataRecord Isobutane(
      name = "Isobutane", MW = 5.812300e+01, molarMass=0.058123, Tc = 4.078000e+02, Pc = 3.640000e+06, Vc = 2.590000e-04, Zc = 2.780000e-01, w = 1.840000e-01, Tb=261.43, lnuA = 1.434751e-02, lnuB = -5.505380e+00,
